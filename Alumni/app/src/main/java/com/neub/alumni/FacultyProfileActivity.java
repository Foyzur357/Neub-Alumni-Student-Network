...
public class FacultyProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pSName = findViewById(R.id.faculty_profile_name_id);
        pSEmail = findViewById(R.id.faculty_profile_email_id);
        pSPhone = findViewById(R.id.faculty_profile_phone_id);


        profileSRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Faculty").child(user.getUid());
